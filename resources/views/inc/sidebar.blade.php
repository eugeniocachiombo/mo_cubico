    ...
    <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100">
            <a href="{{ route('home.dashboard') }}"
                class="nav-item nav-link {{ \Illuminate\Support\Facades\Route::currentRouteName() == 'home.dashboard' ? 'active' : '' }}"><i
                    class="fa fa-tachometer-alt me-2"></i>Painel</a>
            <a href="{{ route('user.profile') }}"
                class="nav-item nav-link {{ \Illuminate\Support\Facades\Route::currentRouteName() == 'user.profile' ? 'active' : '' }}"><i
                    class="fa fa-user me-2"></i>Perfil</a>
            <a href="{{ route('home-rent') }}"
                class="nav-item nav-link {{ \Illuminate\Support\Facades\Route::currentRouteName() == 'home-rent' ? 'active' : '' }}""><i
