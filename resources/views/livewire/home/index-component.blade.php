...
<div>
    ...
    <div class="container-fluid p-5 bg-dark text-secondary">
        ...
        <div id="homesCarousel" class="carousel slide mt-5" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
                    <h1 class="display-4 my-4 text-secondary text-center mb-0">Imóveis Disponíveis para si</h1>
                </div>
                            ...
                            @foreach ($homeChunk as $home)
                                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                                    <div class="position-relative">
                                        @if ($home->photo)
                                            <img class="img-fluid rounded mb-3" src="{{ asset('storage/' . $home->photo) }}" alt="Imagem do imóvel" style="object-fit: cover; height: 200px;">
                                        @else
                                            <div class="d-flex justify-content-center align-items-center bg-secondary" style="width: 100%; height: 200px;">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="mb-1 text-light">
                                                {{ $home->description }} <br>
                                                <span style="font-size: 18px" class="badge bg-dark text-white">{{ number_format($home->price, 2, ',', '.') }} Kz</span>
                                            </p>
                                        ...
                                        <div class="mt-3 text-light">
                                            ...
                                            <div class="d-flex align-items-center">
                                                @if ($home->getOwner->photo)
                                                    <img class="rounded-circle" src="{{ asset('storage/' . $home->getOwner->photo) }}" alt="Foto do proprietário" style="width: 40px; height: 40px;">
                                                @else
                                                    <div class="d-flex justify-content-center align-items-center rounded-circle bg-secondary" style="width: 40px; height: 40px;">
                                                        <i class="fa fa-user text-white"></i>
                                                    </div>
                                                @endif
                                                <div class="ms-3">
                                                    <b>{{ $home->getOwner->first_name }} {{ $home->getOwner->last_name }}</b> <br>
