<div id="homesCarousel" class="carousel slide mt-5" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="col-12 wow fadeIn" data-wow-delay="0.1s">
            @if (\Illuminate\Support\Facades\Route::currentRouteName() == 'home.index')
                <h1 class="display-4 my-4 text-secondary text-center mb-0">Imóveis Disponíveis</h1>
            @endif
        </div>
                    ...
                    @foreach ($homeChunk as $home)
                        <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                            <div class="position-relative">
                                @if ($home->photo)
                                    <img class="img-fluid rounded mb-3" src="{{ asset('storage/' . $home->photo) }}"
