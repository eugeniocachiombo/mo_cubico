        ...
        var myChart1 = new Chart(ctx1, {
            ...
            data: {
                ...
                datasets: [{
                        ...
                        backgroundColor: darkmode ? "rgba(235, 22, 22, .7)" : "rgba(0, 0, 0, .7)"
                    },
                    {
                        label: "Intermediários",
                        data: [8, 35, 40, 60, 70, 55, 75],
                        backgroundColor: darkmode ? "rgba(235, 22, 22, .5)" : "rgba(0, 0, 0, .5)"
                    },
                    {
                        label: "Inquilinos",
                        data: [12, 25, 45, 55, 65, 70, 60],
                        backgroundColor:  darkmode ? "rgba(235, 22, 22, .3)" : "rgba(0, 0, 0, .3)"
                    }
                ]
            },
            options: {
